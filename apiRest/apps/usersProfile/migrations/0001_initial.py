    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('insurances', models.ManyToManyField(to='usersProfile.healthinsurance')),
        ...
        migrations.AddField(
            ...
            name='insurances',
            field=models.ManyToManyField(through='usersProfile.InsurancePlan', to='usersProfile.healthinsurance'),
        ),
        migrations.AddField(
            model_name='doctorprofile',
            name='specialty',
