...
export class AdminReportsComponent implements OnInit {
  ...
  */
  filterSpecialtiesByName(name: string): Medicalspeciality[] {
    if (name) {
      ...
      return this.specialties.filter(specialty => specialty.name.toLowerCase().includes(filterValue));
    } else {
  ...
  */
  loadfilteredBranches(specialtyId: number): void {
    this.specialtyFilteredBranches = this.specialtyFilterService.filterBranchesBySpecialtyName(this.branches, this.getSpecialtyName(specialtyId));
  }
  ...
  * @returns {void}
  */
  resetForm(form: FormGroup, options?: { specialty?: boolean, doctor?: boolean, branch?: boolean }): void {
  ...
  */
  onSubmit(): void {
    if (this.reportForm.valid) {
      ...
      //Faltan acá paciente y obra social
