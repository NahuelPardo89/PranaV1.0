...
@Component({
  selector: 'app-list-insurance-doctor-user',
  templateUrl: './list-insurance-doctor-user.component.html',
  styleUrls: ['./list-insurance-doctor-user.component.css']
})
export class ListInsuranceDoctorUserComponent {
  ...
  setDataTable() {
    this.insuranceDoctorService.getMeDoctorInsurance().subscribe((data) => {
  ...
  insuranceDoctorEdit(insurancePlanDoctor:InsurancePlanDoctor){
    this.router.navigate(['Dashboard/insurances/doctor/me/edit'], {
